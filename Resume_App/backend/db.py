...
def upload_attachment(file_bytes: bytes, file_name: str, file_type: str,
    ...
    """
    # Storage path: file_type/filename (e.g. "cv/CV_Dascalu_Mircea.pdf")
    ...
    # Check if a record with same file_type and file_name already exists
...
def list_attachments(file_type: str = None) -> list[dict]:
    """List all attachments, optionally filtered by file_type."""
